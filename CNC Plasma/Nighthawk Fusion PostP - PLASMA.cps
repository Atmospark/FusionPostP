...
02-05-2025     -     Changed OBversion and renamed to separate from depreciated version
...
description = "CNC3D - Nighthawk - Plasma Only";
vendor = "CNC3D PTY LTD";
vendorUrl = "http://www.cnc3d.com.au";
model = "Plasma Cutter";
obversion = '1.1';										// date updated 02-05-2025
